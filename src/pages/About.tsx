    ...
    <div className="bg-cream min-h-screen">
      ...
      <section className="bg-white border-b border-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold text-primary">Meist</h1>
          <p className="mt-2 text-secondary">Mesila lugu ja pühendumus mesindajatele</p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-6">
              Üle 25 aasta kogemus mesinduses
            </h2>
            <div className="space-y-4 text-secondary leading-relaxed">
              <p>
                Mesila on asutatud 1999. aastal, kui ühendati kirg mesinduse vastu ja soov pakkuda
                kvaliteetseid mesindustarbeid Eesti mesindajatele. Alates esimesest päevast
                oleme olnud pühendunud sellele, et iga toode, mis meie riiulitelt lahkub,
                vastaks kõrgeimatele nõudmistele.
              </p>
              <p>
                Meie tiim koosneb endistest ja praegustest mesindajatest, kes mõistavad
                tarude kaudlikkust ja vajadust usaldusväärsete tarvete järele. Alates
                kaitseriietusest kuni mee töötlemise seadmeten – kõik on testitud reaalses
                töös.
              </p>
              <p>
                Tänaseks oleme Eesti esimesi mesindustarvete tarnijaid, teenindades sadu
                kliente üle Eesti. Meie väärtusteks on kvaliteet, tõhusus ja kliendi
                rahulolu.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-border p-8 md:p-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-secondary text-sm">1-3 tööpäeva jooksul üle Eesti</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-amber/10 rounded-xl mb-4">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-primary mb-2">Kirjutage</h4>
