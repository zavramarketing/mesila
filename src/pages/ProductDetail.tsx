          ...
          <div className="bg-white rounded-xl border border-border p-6 md:p-8">
            ...
            <div className="mt-8">
              <button
                ...
                className={`w-full inline-flex items-center justify-center gap-2 py-3 rounded-lg font-semibold transition-colors ${
                  product.inStock
              ...
              >
                ...
                {product.inStock ? 'Lisa ostukorvi' : 'Laos otsas'}
              </button>
            </div>
